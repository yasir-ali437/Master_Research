...
def main():
    ...
    ap.add_argument("--ckpt", type=str, default="checkpoints_edgeguided/edgeguided_best.pth", required=False,
    ...
    for s in common:
        ...
        fuseImage = fused*255;   #400 for edge guided, 500 for edge dominant
