...
def main():
    ...
    ap.add_argument("--data_root", type=str, default="/mnt/yasir/PET_Dataset_Processed/Separated_Centered_PET_MRI_Updated_Dataset_Splitted/test", required=False,
    ...
    pet_dir = os.path.join(args.data_root, "PET_Deskulled_Colored")
