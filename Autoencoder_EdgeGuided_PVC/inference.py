...
import os
from train import Fusion_net  # your edge-guided net
import numpy as np
import imageio
...
def main():
    ...
    ap.add_argument("--ckpt", type=str, default="checkpoints_pvc/pvc_edgeguided_final.pth", required=False,
    ...
    for s in common:
        ...
        fuseImage = fused*300;   #400 for edge guided, 500 for edge dominant
        ...
        # save_gray(fused, out_path)
        imageio.imwrite(out_path, fuseImage)
