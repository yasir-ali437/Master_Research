...
def run_inference(args):
    ...
    folder_path = f'{args.data_root}/Transported'
    ...
    os.makedirs(os.path.join(args.data_root, args.output_dir), exist_ok=True)
    os.makedirs(os.path.join(args.data_root, args.fused_output_dir), exist_ok=True)
    ...
    for name, mri, pet, mask in tqdm(loader, desc="Inference"):
        ...
        save_path = os.path.join(args.data_root, args.output_dir, f"{name[0]}.png")
    ...
    mri_dir = os.path.join(args.data_root, args.data_root, "MRI")
    pet_dir = os.path.join(args.data_root, args.data_root, "Transported")
    mask_dir = os.path.join(args.data_root, args.data_root, "GM")
    ...
    for s in common:
        ...
        out_path = os.path.join(args.data_root, args.fused_output_dir, f"{s}.png")
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_root", type=str, default="/mnt/yasir/PET_Dataset_Processed/Separated_Centered_PET_MRI_Updated_Dataset_Splitted/test",
    ...
    parser.add_argument("--checkpoint_fusion", type=str, default="checkpoints_edgeguided/edgeguided_final.pth",
                        help="Path to trained model checkpoint")
    parser.add_argument("--output_dir", type=str, default="Transported",
                        help="Directory to save fused results")
    parser.add_argument("--fused_output_dir", type=str, default="Fused_Images",
                        help="Directory to save fused results")
